...
namespace HospitalManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20250729180712_deletedDoctorWorkingHours")]
    partial class deletedDoctorWorkingHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagementSystem.Core.Entities.Appointment", b =>
                {
                    ...
                    b.ToTable("Appointments", t =>
                        {
                            t.HasCheckConstraint("CHK_Appointment_Date_Range", "\"Date\" >= CURRENT_DATE AND \"Date\" <= (CURRENT_DATE + INTERVAL '1 month')");
                        });
                });
            ...
            modelBuilder.Entity("HospitalManagementSystem.Core.Entities.TimeSlot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Core.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("HospitalManagementSystem.Core.Entities.TimeSlot", "TimeSlot")
                        .WithMany("Appointments")
